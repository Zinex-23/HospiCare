...
const colorPresetsHex =
  ['#4C6343', '#F44336', '#E89623', '#F5DD00', '#8BC34A', '#4CAF50', '#3B9600', '#38D304', '#3AB743', '#9C27B0', '#E91E63', '#6F113A',
   '#A1ADB1', '#F9A19B', '#FFD190', '#FFF59D', '#C5E1A4', '#A5D7A7', '#9ECB80', '#9BE981', '#9CDBA0', '#CD93D7', '#F48FB1', '#BC91A4'];
