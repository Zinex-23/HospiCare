      ...
      links: [
        {
          ...
          link: 'https://hospicare.io/docs/getting-started-guides/helloworld/'
        },
        {
          icon: 'title',
          name: 'Tenant profiles',
          link: 'https://hospicare.io/docs/user-guide/tenant-profiles/'
        },
        {
          icon: 'insert_chart',
          name: 'API',
          link: 'https://hospicare.io/docs/api/'
        },
        {
          icon: 'now_widgets',
          name: 'Widgets Library',
          link: 'https://hospicare.io/docs/user-guide/ui/widget-library/'
        }
      ]
    }],
    [Authority.TENANT_ADMIN, {
      links: [
        ...
        },
        {
          ...
          name: 'Rule engine',
          link: 'https://hospicare.io/docs/user-guide/rule-engine-2-0/re-getting-started/'
        },
        {
          icon: 'insert_chart',
          name: 'API',
        ...
        },
        {
          ...
          link: 'https://hospicare.io/docs/user-guide/device-profiles/'
        }
      ]
    }],
