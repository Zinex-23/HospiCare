...
The behavior of this action depends on the type of widget action configured in the HospiCare platform (e.g., navigating to a dashboard state, updating the current state, opening a URL, etc.).
